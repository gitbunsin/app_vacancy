                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="item-fl-box">
                                <div class="brows-job-company-img">
                                    <a href="job-detail.html"><img src="{{asset('img/about/about-us.jpg')}}" class="img-responsive" alt="" /></a>
                                </div>
                                <div class="brows-job-position">
                                    <h3><a href="{{url('app-profile-Candidate')}}">Digital Marketing Manager</a></h3>
                                    <p>
