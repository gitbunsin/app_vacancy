                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                        ...
                                                                        <p style="margin: 20px 0 30px 0;font-size: 13px;text-align: center;">Help us secure your SrolanhJob account by verifying your email address <br/><a href="#">{{url('Register/activate/email/'.$user_mail->id.'/'.$user_mail->email_token)}}</a></p>
